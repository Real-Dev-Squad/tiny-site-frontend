...
const RedirectShimmer = () => {
    return (
        <section
            className="w-screen min-h-screen flex flex-col items-center justify-center bg-custom-blue text-white p-4"
            data-testid="redirect-shimmer"
        >
            <div className="text-lg animate-pulse bg-gray-400 h-6 w-2/3 rounded mb-2"></div>
            <p className="text-xl font-bold text-center truncate animate-pulse bg-white h-8 w-4/5 rounded mb-2"></p>
            <div className="text-lg animate-pulse bg-gray-400 h-6 w-2/3 rounded mb-2"></div>
